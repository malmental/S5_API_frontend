 ...
 * ============================================================
 * Description: 
 *   Public landing page showing branding, system features
 ...
 *   5. Product Visual - Visual terminal section
 *   6. Footer - Footer
 * 
 * Technical notes:
 *   - No authentication required (public)
 *   - External links (RESOURCES, DOCS, STATUS) are placeholders
 *   - Terminal image from Google CDN (could be localized)
    ...
    <div className="flex flex-col min-h-screen bg-surface">
      ...
      <main className="flex-grow flex flex-col">
        ...
        {/* ============================================================
            ...
            Description: Visual demonstration section of the product
